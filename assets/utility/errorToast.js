export default function errorToast(message) {
    ...
    toastContainer.classList.add("toastBox");
    ...
    toastContainer.innerHTML = `
      <div class="flex items-center space-x-2">
          <i class="ri-error-warning-fill errorIcon text-[22px]"></i>
        ...
        <button
          type="button"
          class="ml-4 fixed right-3 top-1/2 text-gray-400  hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 inline-flex items-center justify-center h-8 w-8"
          aria-label="Close"
        >
        ...
        <div
          class="toastLine after:absolute after:left-0 after:bottom-0 after:w-[0%] after:h-[4px] after:bg-[#ff0000]"
        ></div>
      `;
